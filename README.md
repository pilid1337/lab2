...
Считываем список цифр заданной длинны. Создаём новый список, применив к каждому элементу исходного списка функцию, утанавливающую соответствие между десятичной цифрой и римской цифрой
